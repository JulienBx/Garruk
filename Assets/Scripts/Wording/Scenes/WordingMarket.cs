...
public class WordingMarket
{
	...
	static WordingMarket()
	{
		...
		references.Add(new string[]{"Bienvenue sur le marché. Vous pouvez ici acheter des unités mises en vente par d'autres joueurs, et mettre en vente vos propres unités. Attention les unités faisant partie d'une équipe ne pourront être mises en vente","Welcome to the market. Here you will find unit selling offers made by other players. You can either buy units by choosing an offer or put your stock units on sale. Be careful, you won't be able to sell units that belong to a team."}); //5

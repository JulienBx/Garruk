...
public class WordingMarket
{
	...
	static WordingMarket()
	{
		...
		references.Add(new string[]{"Acheter la carte",""}); //8
		references.Add(new string[]{"Editer la vente",""}); //9
		references.Add(new string[]{"Pour éditer la vente ...",""}); //10
		references.Add(new string[]{"Mettre en vente",""}); //11
		references.Add(new string[]{"Pour mettre en vente ...",""}); //12
	}
}
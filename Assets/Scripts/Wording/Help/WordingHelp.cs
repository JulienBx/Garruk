...
public class WordingHelp
{
	...
	static WordingHelp()
	{
		...
		helpContents.Add(new string[]{"La faction de l'unité détermine les compétences auxquelles l'unité a accès, ainsi que sa mobilité sur le champ de bataille","Faction determines which skills can be used by the unit. Movement  "}); //0

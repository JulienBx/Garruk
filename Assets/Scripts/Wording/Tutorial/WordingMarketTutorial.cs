...
public class WordingMarketTutorial
{
	...
	static WordingMarketTutorial()
	{
		...
		helpContents.Add(new string[]{"Les colons peuvent acquérir des unités appartenant à leurs confrères, moyennant une compensation décidée par le vendeur. Les unités disponibles sur ce marché sont toutes visibles ici",""}); //1

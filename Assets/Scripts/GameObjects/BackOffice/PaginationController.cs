...
{	
	...
	public void resize()
	{
		...
		this.buttons[0].transform.localPosition=new Vector3 (- 0.025f - ApplicationDesignRules.paginationButtonWorldSize.x / 2f, 0f, 0f);
		this.buttons[1].transform.localPosition=new Vector3 (0.025f + ApplicationDesignRules.paginationButtonWorldSize.x / 2f, 0f, 0f);
	}

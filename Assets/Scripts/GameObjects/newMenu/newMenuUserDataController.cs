...
public class newMenuUserDataController : MonoBehaviour 
{
	...
	void OnMouseOver()
	{
		...
		gameObject.transform.FindChild("Credits").GetComponent<TextMeshPro>().color=new Color(155f/255f,220f/255f,1f);
	}
	void OnMouseExit()
	{
		gameObject.GetComponent<SpriteRenderer>().color=new Color(1f,1f, 1f);
		gameObject.transform.FindChild("Username").GetComponent<TextMeshPro>().color=new Color(1f,1f,1f);
		gameObject.transform.FindChild("Credits").GetComponent<TextMeshPro>().color=new Color(1f,1f,1f);
	}
	void OnMouseDown()
	{

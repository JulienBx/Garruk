...
public class NewFocusedCardLobbyController : NewFocusedCardController
{
	...
	{
		NewLobbyController.instance.refreshCredits ();
	}
	public override void exitFocus()
	{
		base.exitFocus ();
		NewLobbyController.instance.hideCardFocused ();
	}

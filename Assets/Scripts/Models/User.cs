...
public class User
{
	...
	private string URLSetLobbyTutorial = ApplicationModel.host + "set_lobbyTutorial.php";
	...
	private string URLSetDisplayTutorial = ApplicationModel.host + "set_displaytutorial.php";

...
public class Card 
{
	...
	public void setString()
	{
		...
		this.String+=this.ExperienceLevel.ToString()+"\\"; //13
		this.String+=this.PercentageToNextLevel.ToString()+"\\"; //14
		this.String+=this.NextLevelPrice.ToString()+"\\"; //15
		this.String+=this.onSale.ToString()+"\\"; //16
		this.String+=this.Price.ToString()+"\\"; //17
		this.String+=this.OnSaleDate.ToString("yyyy-MM-dd HH:mm:ss")+"\\"; //18
		this.String+=this.nbWin.ToString()+"\\"; //19
		this.String+=this.nbLoose.ToString()+"\\"; //20
		this.String+=this.destructionPrice.ToString()+"\\"; //21
		this.String+=this.Power.ToString()+"\\"; //22
		this.String+=this.LifeNbUpgrades.ToString()+"\\"; //23
		this.String+=this.AttackNbUpgrades.ToString()+"\\"; //24
		this.String+=this.UpgradedLife.ToString()+"\\"; //25
		this.String+=this.UpgradedAttack.ToString()+"\\"; //26
		this.String+=this.UpgradedSpeed.ToString()+"\\"; //27
		this.String+=this.UpgradedLifeLevel.ToString()+"\\"; //28
		this.String+=this.UpgradedAttackLevel.ToString()+"\\"; //29
		this.String+=this.UpgradedSpeedLevel.ToString()+"\\"; //30

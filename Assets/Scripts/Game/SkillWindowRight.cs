...
{	
	...
	public void setReceivers(List<Card> receivers, List<string> textesUp, List<string> textesDown, List<int> status){
		...
		for (int i = 0 ; i < this.nbReceivers ; i++){
			...
			gameObject.transform.FindChild("HitMan"+i).FindChild("UpgradeBox").GetComponent<SpriteRenderer>().enabled=true;
			gameObject.transform.FindChild("HitMan"+i).FindChild("DowngradeBox").GetComponent<SpriteRenderer>().enabled=true;
			gameObject.transform.FindChild("HitMan"+i).FindChild("UpgradeBox").FindChild("BoxText").GetComponent<MeshRenderer>().enabled=true;
			gameObject.transform.FindChild("HitMan"+i).FindChild("DowngradeBox").FindChild("BoxText").GetComponent<MeshRenderer>().enabled=true;

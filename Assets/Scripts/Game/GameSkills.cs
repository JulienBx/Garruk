...
{	
	...
	public void initialize(){
		...
		this.skills [36] = new Reparation();
		this.skills [37] = new Virus();
		this.skills [38] = new Tourelle();
		...
		this.skills [44] = new Fontaine();
		this.skills [45] = new ArmureTech();
		this.skills [46] = new Caserne();
		...
		this.skills [100] = new Renaissance();

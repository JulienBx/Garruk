...
//		List<string> textesPV =  new List<string>();
//		List<string> textesAttack =  new List<string>();
//		List<string> textesMove =  new List<string>();
//		List<string> textesEffects =  new List<string>();
...
//			}	
//		}
//		GameView.instance.setSkillPopUp("Attaque", base.card, receivers, textesPV, textesAttack, textesMove, textesEffects, status);
//	}
//	

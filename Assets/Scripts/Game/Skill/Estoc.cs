	...
	public override void applyOn(){
		...
		for(int i = 0 ; i < base.targets.Count ; i++){
			...
			if (base.results[i]==0){
				...
				GameView.instance.getGC().addCardModifier(target, -1*amount2, ModifierType.Type_BonusMalus, ModifierStat.Stat_Attack, 1, 5, "Affaibli", "-"+amount2+" ATK pendant 1 tour", "Actif 1 tour");

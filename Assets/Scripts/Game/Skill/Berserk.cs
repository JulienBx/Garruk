...
public class Berserk : GameSkill
{
	...
	public override void applyOn(int target){
		...
		int damages = currentCard.getNormalDamagesAgainst(targetCard, Mathf.RoundToInt(currentCard.getAttack()*(1f+level/20f)));
		int autoDamages = currentCard.getNormalDamagesAgainst(targetCard, Mathf.RoundToInt(currentCard.getAttack()*25f/100f));
		string text = "-"+damages+"PV";				
		string autotext = "S'inflige "+autoDamages+" dégats";				

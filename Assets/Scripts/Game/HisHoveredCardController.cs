...
{	
	...
	public void setCard(Card c){
		...
		gameObject.transform.FindChild("HisMainDescription").FindChild("HisPassiveSkill").FindChild("HisSpecialite").GetComponent<TextMeshPro>().text = c.getSkills()[0].Name;
		...
		gameObject.transform.FindChild("HisMainDescription").FindChild("HisCarac").FindChild("HisHasteText").GetComponent<TextMeshPro>().text = ""+c.GetSpeedString();
		...
		for (int i = 1 ; i < c.getSkills().Count ; i++){
			...
			gameObject.transform.FindChild("HisMainDescription").FindChild("HisSkill"+i).FindChild("HisSkill"+(i)+"Title").GetComponent<TextMeshPro>().text = c.getSkills()[i].Name;

...
public class MitrailletteC : SkillC
{
	public MitrailletteC(){
		base.id = 30 ;
		base.ciblage = 13;
		base.animId = 4;
		base.soundId = 25;
	...
	public override void resolve(int x, int y, Skill skill){
		...
		List<TileM> neighbours = Game.instance.getBoard().getUnitsStraightLine(Game.instance.getCurrentCard().getTileM(), new TileM(x,y), Game.instance.getBoard().getCurrentBoard());

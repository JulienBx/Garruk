...
{ 
	...
	static private Vector3 companionOriginalScale=new Vector3(0.6f,0.6f,0.6f);
	...
	static private Vector3 profileStatMobileScale = new Vector3 (0.9f, 0.9f, 0.9f);

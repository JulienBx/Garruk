...
//{
//	public static myGameController2 instance;
...
//		yield break;
//	}
//	public IEnumerator renameCard(string name)
//	{
//		yield break;
//	}
...
//		{
//			this.onLeftClickOnDeckCard(go);
//		} else if (go.name.StartsWith("Card"))
//		{
//			this.onLeftClickOnCard(go);
//		}
//	}
//	public void onLeftClickOnDeckCard(GameObject go)
//	{
//		this.RemoveCardFromDeck(myGameView.myDecksVM.chosenIdDeck, 
...
//			}
//			
//			myGameView.myGameVM.cardFocused = Instantiate(this.CardObject) as GameObject;
//
//			float scale = this.heightScreen / 120f;
...
//			myGameView.myGameVM.cardFocused.transform.localPosition = Camera.main.ScreenToWorldPoint(new Vector3(0.50f * this.widthScreen, 
//			                                                                                          0.45f *this.heightScreen - 1, 
//			                                                                                          10)); 
...
//			myGameView.myGameVM.cardFocused.GetComponent<CardMyGameController>().setFocusMyGameFeatures(true);
...
//			
//			myGameView.myDecksVM.rectFocus = new Rect(0.50f * this.widthScreen + (vec.x - this.widthScreen / 2f) / 2f, 0.15f * this.heightScreen, 
//			                               0.25f * this.widthScreen, 0.8f * this.heightScreen);
//		}
//	
//	}
//
...
//		for (int i = 0; i < 3 * myGameView.myGameVM.nbCardsPerRow; i++)
//		{
//			GameObject card = myGameView.myGameVM.displayedCards [i] = Instantiate(this.CardObject) as GameObject;
//
//
...
//		for (int i = 0; i < 5; i++)
//		{
//			GameObject card = myGameView.myGameVM.displayedDeckCards [i] = Instantiate(this.CardObject) as GameObject;
//

...
public class BackOfficeController : MonoBehaviour 
{
	...
	{
		this.instance.displayTransparentBackground ();
	...
	public void hideErrorPopUp()
	{
		...
		this.instance.hideTransparentBackground();
	...
	public IEnumerator sendInvitation(User invitedUser, User sendingUser)
	{
		...
		this.instance.changeLoadingScreenLabel(WordingSocial.getReference(6));
	...
	public IEnumerator getUserData()
	{
		...
		else if(nbNotificationsNonReads!=ApplicationModel.player.NbNotificationsNonRead)
		{
			MenuController.instance.refreshMenuObject();
		}

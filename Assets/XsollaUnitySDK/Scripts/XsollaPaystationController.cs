...
//			throw new System.NotImplementedException ();
		...
		private void OpenError(XsollaError error)
		{
			if (mainScreenContainer != null) {
				...
				GameObject errorScreen = Instantiate (Resources.Load ("Prefabs/Screens/MainScreenError")) as GameObject;
		...
		private void InitMenu(XsollaUtils utils)
		{
			...
			GameObject menuItemIconPrefab = Resources.Load ("Prefabs/SimpleView/MenuItemIcon") as GameObject;
			GameObject menuItemEmptyPrefab = Resources.Load ("Prefabs/SimpleView/MenuItemEmpty") as GameObject;
